...
namespace URWPGSim2D.Common
{
    ...
    public class Field : ICloneable, IDssSerializable
    {
        ...
        /// 障碍越野用圆的屏幕半径（**待求**），单位像素
        /// </summary>
        public int ObstacleCircleRadiusPix { get; set; }
        ...
        /// </summary>
        [DataMember]
        public int ObstacleCircleRadiusMm { get; set; }
        ...
        public void SetField()
        {
            ...
            try
            {
                ...
                ObstacleCircleRadiusMm = Convert.ToInt32(myConfig.MyXmlReader("ObstacleircleRadiusMm"));
            }
            catch
            {
        ...
        public void FieldCalculation()
        {
            ...
            if (dRatioFieldXMmAndZMm <= dRatioPictureBoxWidthAndHeight)
            {
                ...
                ObstacleCircleRadiusPix = (int)(ObstacleCircleRadiusMm / ScaleMmToPix + 0.5);
        ...
        public Bitmap Draw(Bitmap bmp, bool IsGoalBlockNeeded, int IsFieldInnerLinesNeeded)
        {
            ...
            else if (IsFieldInnerLinesNeeded == 4)
            {
                ...
                myGraphic.DrawEllipse(new Pen(Brushes.White, 3),
                           FieldLengthXPix / 2 + FieldInnerBorderPix + FieldOuterBorderPix + OffsetWidthPix - ObstacleCircleRadiusPix - 3,
                           FieldLengthZPix / 2 + FieldInnerBorderPix + FieldOuterBorderPix - OffsetHeightPix - ObstacleCircleRadiusPix,
                           ObstacleCircleRadiusPix * 2, ObstacleCircleRadiusPix * 2);

                myGraphic.DrawString(Convert.ToString(1), new Font("宋体", ObstacleCircleRadiusPix * 36 / 20), Brushes.White,
                               FieldLengthXPix / 2 + FieldInnerBorderPix + FieldOuterBorderPix + OffsetWidthPix - ObstacleCircleRadiusPix + ObstacleCircleRadiusPix * 22 / 80,
                           FieldLengthZPix / 2 + FieldInnerBorderPix + FieldOuterBorderPix - OffsetHeightPix - ObstacleCircleRadiusPix + ObstacleCircleRadiusPix * 15 / 80);
                ...
                myGraphic.DrawString(Convert.ToString(2), new Font("宋体", ObstacleCircleRadiusPix * 36 / 20), Brushes.White,
                           FieldLengthXPix / 2 + FieldInnerBorderPix + FieldOuterBorderPix + OffsetWidthPix - ObstacleCircleRadiusPix + ObstacleCircleRadiusPix * 22 / 80,
                           FieldLengthZPix / 2 + FieldInnerBorderPix + FieldOuterBorderPix + OffsetHeightPix - ObstacleCircleRadiusPix + ObstacleCircleRadiusPix * 15 / 80);
